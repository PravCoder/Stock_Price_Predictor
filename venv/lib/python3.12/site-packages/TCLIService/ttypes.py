...
class TOpenSessionReq(object):
    ...
    def __init__(self, client_protocol=9, username=None, password=None, configuration=None, keyStore=None, trustStore=None, keyStorePassword=None, trustStorePassword=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.keyStore = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRING:
                    self.trustStore = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.STRING:
                    self.keyStorePassword = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.STRING:
                    self.trustStorePassword = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.keyStore is not None:
            ...
            oprot.writeBinary(self.keyStore)
            oprot.writeFieldEnd()
        if self.trustStore is not None:
            oprot.writeFieldBegin('trustStore', TType.STRING, 6)
            oprot.writeBinary(self.trustStore)
            oprot.writeFieldEnd()
        if self.keyStorePassword is not None:
            oprot.writeFieldBegin('keyStorePassword', TType.STRING, 7)
            oprot.writeString(self.keyStorePassword.encode('utf-8') if sys.version_info[0] == 2 else self.keyStorePassword)
            oprot.writeFieldEnd()
        if self.trustStorePassword is not None:
            oprot.writeFieldBegin('trustStorePassword', TType.STRING, 8)
            oprot.writeString(self.trustStorePassword.encode('utf-8') if sys.version_info[0] == 2 else self.trustStorePassword)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
TOpenSessionReq.thrift_spec = (
    ...
    (5, TType.STRING, 'keyStore', 'BINARY', None, ),  # 5
    (6, TType.STRING, 'trustStore', 'BINARY', None, ),  # 6
    (7, TType.STRING, 'keyStorePassword', 'UTF8', None, ),  # 7
    (8, TType.STRING, 'trustStorePassword', 'UTF8', None, ),  # 8
)
