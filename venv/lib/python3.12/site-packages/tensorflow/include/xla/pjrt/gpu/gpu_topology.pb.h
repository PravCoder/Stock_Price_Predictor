...
enum GpuVersionProto : int {
  GPU_VERSION_UNSPECIFIED = 0,
  GPU_VERSION_A100 = 1,
  GPU_VERSION_H100 = 2,
  GpuVersionProto_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  GpuVersionProto_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool GpuVersionProto_IsValid(int value);
constexpr GpuVersionProto GpuVersionProto_MIN = GPU_VERSION_UNSPECIFIED;
constexpr GpuVersionProto GpuVersionProto_MAX = GPU_VERSION_H100;
constexpr int GpuVersionProto_ARRAYSIZE = GpuVersionProto_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* GpuVersionProto_descriptor();
template<typename T>
inline const std::string& GpuVersionProto_Name(T enum_t_value) {
  static_assert(::std::is_same<T, GpuVersionProto>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function GpuVersionProto_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    GpuVersionProto_descriptor(), enum_t_value);
}
inline bool GpuVersionProto_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, GpuVersionProto* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<GpuVersionProto>(
    GpuVersionProto_descriptor(), name, value);
}
// ===================================================================
...
class GpuTopologyProto final :
 ...
 public:
  ...
  // .xla.GpuVersionProto gpu_version = 2;
  void clear_gpu_version();
  ::xla::GpuVersionProto gpu_version() const;
  void set_gpu_version(::xla::GpuVersionProto value);
  private:
  ::xla::GpuVersionProto _internal_gpu_version() const;
  void _internal_set_gpu_version(::xla::GpuVersionProto value);
  public:
...
// .xla.GpuVersionProto gpu_version = 2;
inline void GpuTopologyProto::clear_gpu_version() {
  _impl_.gpu_version_ = 0;
}
inline ::xla::GpuVersionProto GpuTopologyProto::_internal_gpu_version() const {
  return static_cast< ::xla::GpuVersionProto >(_impl_.gpu_version_);
}
inline ::xla::GpuVersionProto GpuTopologyProto::gpu_version() const {
  // @@protoc_insertion_point(field_get:xla.GpuTopologyProto.gpu_version)
  return _internal_gpu_version();
}
inline void GpuTopologyProto::_internal_set_gpu_version(::xla::GpuVersionProto value) {
  
  _impl_.gpu_version_ = value;
}
inline void GpuTopologyProto::set_gpu_version(::xla::GpuVersionProto value) {
  _internal_set_gpu_version(value);
  // @@protoc_insertion_point(field_set:xla.GpuTopologyProto.gpu_version)
}
...
template <> struct is_proto_enum< ::xla::GpuVersionProto> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::xla::GpuVersionProto>() {
  return ::xla::GpuVersionProto_descriptor();
}
