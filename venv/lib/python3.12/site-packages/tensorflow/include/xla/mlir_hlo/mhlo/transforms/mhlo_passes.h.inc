...
#define GEN_PASS_DECL_MHLOQUANTLEGALIZETOINT
...
//===----------------------------------------------------------------------===//
// MhloQuantLegalizeToInt
//===----------------------------------------------------------------------===//
#ifdef GEN_PASS_DECL_MHLOQUANTLEGALIZETOINT
#undef GEN_PASS_DECL_MHLOQUANTLEGALIZETOINT
#endif // GEN_PASS_DECL_MHLOQUANTLEGALIZETOINT
#ifdef GEN_PASS_DEF_MHLOQUANTLEGALIZETOINT
namespace impl {

template <typename DerivedT>
class MhloQuantLegalizeToIntBase : public ::mlir::OperationPass<mlir::func::FuncOp> {
public:
  using Base = MhloQuantLegalizeToIntBase;

  MhloQuantLegalizeToIntBase() : ::mlir::OperationPass<mlir::func::FuncOp>(::mlir::TypeID::get<DerivedT>()) {}
  MhloQuantLegalizeToIntBase(const MhloQuantLegalizeToIntBase &other) : ::mlir::OperationPass<mlir::func::FuncOp>(other) {}
  MhloQuantLegalizeToIntBase& operator=(const MhloQuantLegalizeToIntBase &) = delete;
  MhloQuantLegalizeToIntBase(MhloQuantLegalizeToIntBase &&) = delete;
  MhloQuantLegalizeToIntBase& operator=(MhloQuantLegalizeToIntBase &&) = delete;
  ~MhloQuantLegalizeToIntBase() = default;

  /// Returns the command-line argument attached to this pass.
  static constexpr ::llvm::StringLiteral getArgumentName() {
    return ::llvm::StringLiteral("mhlo-quant-legalize-to-int");
  }
  ::llvm::StringRef getArgument() const override { return "mhlo-quant-legalize-to-int"; }

  ::llvm::StringRef getDescription() const override { return "Convert from MHLO quantized ops to MHLO primitive ops."; }

  /// Returns the derived pass name.
  static constexpr ::llvm::StringLiteral getPassName() {
    return ::llvm::StringLiteral("MhloQuantLegalizeToInt");
  }
  ::llvm::StringRef getName() const override { return "MhloQuantLegalizeToInt"; }
  ...
  /// instantiation because Pass classes should only be visible by the current
  /// library.
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(MhloQuantLegalizeToIntBase<DerivedT>)

protected:
private:
};
} // namespace impl
#undef GEN_PASS_DEF_MHLOQUANTLEGALIZETOINT
#endif // GEN_PASS_DEF_MHLOQUANTLEGALIZETOINT
...
//===----------------------------------------------------------------------===//
// MhloQuantLegalizeToInt Registration
//===----------------------------------------------------------------------===//

inline void registerMhloQuantLegalizeToInt() {
  ::mlir::registerPass([]() -> std::unique_ptr<::mlir::Pass> {
    return createMhloQuantLegalizeToIntPass();
  });
}

// Old registration code, kept for temporary backwards compatibility.
inline void registerMhloQuantLegalizeToIntPass() {
  ::mlir::registerPass([]() -> std::unique_ptr<::mlir::Pass> {
    return createMhloQuantLegalizeToIntPass();
  });
}
...
inline void registerAllMhloPasses() {
  ...
  registerMhloQuantLegalizeToInt();
